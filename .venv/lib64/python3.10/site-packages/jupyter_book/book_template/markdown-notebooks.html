...
<html lang="en" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>Notebooks with MyST Markdown &#8212; LLM Inference using Aitta</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib64/python3.10/site-packages/jupyter_book/book_template/markdown-notebooks';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/csc-training/llm-inference-using-aitta/edit/main/./.venv/lib64/python3.10/site-packages/jupyter_book/book_template/markdown-notebooks.md" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/csc-training/llm-inference-using-aitta/issues/new?title=Issue%20on%20page%20%2F.venv/lib64/python3.10/site-packages/jupyter_book/book_template/markdown-notebooks.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv/lib64/python3.10/site-packages/jupyter_book/book_template/markdown-notebooks.md" target="_blank"
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">jupyter</span><span class="o">-</span><span class="n">book</span> <span class="n">myst</span> <span class="n">init</span> <span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">markdownfile</span><span class="o">.</span><span class="n">md</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib64/python3.10/site-packages/jupyter_book/book_template"
        },
