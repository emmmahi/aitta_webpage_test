...
<html lang="en" data-content_root="../../../../../../../../" >
  ...
  <head>
    ...
    <title>This is an Jupyter notebook backed by a Ruby kernel &#8212; LLM Inference using Aitta</title>
...
<link rel="preload" as="script" href="../../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib64/python3.10/site-packages/mkdocs_jupyter/tests/mkdocs/docs/ruby';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/csc-training/llm-inference-using-aitta/edit/main/./.venv/lib64/python3.10/site-packages/mkdocs_jupyter/tests/mkdocs/docs/ruby.ipynb" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/csc-training/llm-inference-using-aitta/issues/new?title=Issue%20on%20page%20%2F.venv/lib64/python3.10/site-packages/mkdocs_jupyter/tests/mkdocs/docs/ruby.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../../_sources/.venv/lib64/python3.10/site-packages/mkdocs_jupyter/tests/mkdocs/docs/ruby.ipynb" target="_blank"
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>This is an Jupyter notebook backed by a Ruby kernel</h1>
    <!-- Table of contents -->
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#what-does-this-give-you">What does this give you?</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#usage">Usage</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#example">Example</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#display">Display</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#integration-with-ruby-gems">Integration with Ruby gems</a><ul class="nav section-nav flex-column">
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#pry">Pry</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#gnuplot">Gnuplot</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#rubyvis">Rubyvis</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#matrix-gsl">Matrix &amp; GSL</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#nyaplot">Nyaplot</a></li>
</ul>
</li>
</ul>
            </nav>
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="this-is-an-jupyter-notebook-backed-by-a-ruby-kernel">
<h1>This is an Jupyter notebook backed by a Ruby kernel<a class="headerlink" href="#this-is-an-jupyter-notebook-backed-by-a-ruby-kernel" title="Link to this heading">#</a></h1>
<p>I am developing <a class="reference external" href="https://github.com/SciRuby/iruby">IRuby</a> a kernel in Ruby that adheres to the <a class="reference external" href="http://jupyter.org/">Jupyter</a>/<a class="reference external" href="http://ipython.org/">IPython</a> messaging protocol. It integrates nicely with different Rubygems as will be shown later.</p>
<section id="what-does-this-give-you">
<h2>What does this give you?<a class="headerlink" href="#what-does-this-give-you" title="Link to this heading">#</a></h2>
<p>This gives us a very fancy web notebook interface for Ruby.  It’s a very good tool for programming presentations. It’s basically an in-browser REPL loop, with some extra goodies.</p>
</section>
<section id="usage">
<h2>Usage<a class="headerlink" href="#usage" title="Link to this heading">#</a></h2>
<p>Install IRuby with:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">gem</span> <span class="n">install</span> <span class="n">iruby</span>
</pre></div>
</div>
<p>Start the IRuby notebook with:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">iruby</span> <span class="n">notebook</span>
</pre></div>
</div>
</section>
<section id="example">
<h2>Example<a class="headerlink" href="#example" title="Link to this heading">#</a></h2>
<p><code class="docutils literal notranslate"><span class="pre">$stdout</span></code> and <code class="docutils literal notranslate"><span class="pre">$stderr</span></code> are redirected to the notebook</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="nb">puts</span><span class="w"> </span><span class="s1">&#39;Hello, world!&#39;</span>
</pre></div>
</div>
</div>
...
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="vg">$stderr</span><span class="o">.</span><span class="n">puts</span><span class="w"> </span><span class="s1">&#39;Error!&#39;</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output stderr highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>Error!
</pre></div>
</div>
</div>
</div>
<p>The last computed result is returned.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">Math</span><span class="o">.</span><span class="n">sqrt</span><span class="p">(</span><span class="mi">2</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
...
<p>This works even for images.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">File</span><span class="o">.</span><span class="n">open</span><span class="p">(</span><span class="s1">&#39;IRuby Examples/ruby.svg&#39;</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<img alt="../../../../../../../../_images/a91a3ee3b3ac1e0ba95e964651b09e1124633a893a8e7e8f2f47dd57196e7bfb.svg" src="../../../../../../../../_images/a91a3ee3b3ac1e0ba95e964651b09e1124633a893a8e7e8f2f47dd57196e7bfb.svg" />
</div>
</div>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">File</span><span class="o">.</span><span class="n">open</span><span class="p">(</span><span class="s1">&#39;IRuby Examples/ruby.png&#39;</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<img alt="../../../../../../../../_images/9a7a027d4f01d51a7e42fcd4b3365935310c8ff2ccfb00264ddc26d3ea52116d.png" src="../../../../../../../../_images/9a7a027d4f01d51a7e42fcd4b3365935310c8ff2ccfb00264ddc26d3ea52116d.png" />
</div>
</div>
</section>
<section id="display">
<h2>Display<a class="headerlink" href="#display" title="Link to this heading">#</a></h2>
<p>IRuby provides a method to display objects <code class="docutils literal notranslate"><span class="pre">IRuby.display</span></code> and methods to create <span class="math notranslate nohighlight">\(\LaTeX\)</span> and HTML representations.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="s1">&#39;&lt;b style=&quot;color:green&quot;&gt;Hello, world!&lt;/b&gt;&#39;</span><span class="p">,</span><span class="w"> </span><span class="ss">mime</span><span class="p">:</span><span class="w"> </span><span class="s1">&#39;text/html&#39;</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output text_html"><b style="color:green">Hello, world!</b></div></div>
</div>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">IRuby</span><span class="o">.</span><span class="n">html</span><span class="w"> </span><span class="s1">&#39;&lt;iframe src=http://en.mobile.wikipedia.org/?useformat=mobile width=700 height=350&gt;&lt;/iframe&gt;&#39;</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output text_html"><iframe src=http://en.mobile.wikipedia.org/?useformat=mobile width=700 height=350></iframe></div></div>
</div>
<p><span class="math notranslate nohighlight">\(\LaTeX\)</span> is rendered using MathJax.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">latex</span><span class="w"> </span><span class="o">&lt;&lt;-</span><span class="sh">&#39;</span><span class="dl">TEX</span><span class="sh">&#39;</span>
<span class="sh">\begin{eqnarray}</span>
...
<span class="sh">\end{eqnarray}</span>
<span class="dl">TEX</span>

<span class="no">IRuby</span><span class="o">.</span><span class="n">math</span><span class="p">(</span><span class="s1">&#39;F(k) = \int_{-\infty}^{\infty} f(x) e^{2\pi i k} dx&#39;</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
...
<div class="output text_latex math notranslate nohighlight">
\[F(k) = \int_{-\infty}^{\infty} f(x) e^{2\pi i k} dx\]</div>
</div>
</div>
<p>Arrays and Hashes can be printed as HTML tables.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">(</span><span class="o">[</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">,</span><span class="o">[]</span><span class="p">,</span><span class="mi">3</span><span class="o">]</span><span class="p">)</span>
<span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">({</span><span class="ss">a</span><span class="p">:</span><span class="mi">1</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="mi">2</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="mi">3</span><span class="p">})</span>
<span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">(</span><span class="o">[[</span><span class="mi">11</span><span class="p">,</span><span class="mi">12</span><span class="p">,</span><span class="mi">13</span><span class="p">,</span><span class="mi">14</span><span class="o">]</span><span class="p">,</span><span class="o">[</span><span class="mi">21</span><span class="p">,</span><span class="mi">22</span><span class="p">,</span><span class="mi">23</span><span class="o">]</span><span class="p">,</span><span class="s1">&#39;not an Array&#39;</span><span class="p">,</span><span class="o">[</span><span class="mi">31</span><span class="p">,</span><span class="mi">32</span><span class="p">,</span><span class="mi">33</span><span class="p">,</span><span class="mi">34</span><span class="o">]]</span><span class="p">)</span>
<span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">({</span><span class="ss">a</span><span class="p">:</span><span class="o">[</span><span class="mi">11</span><span class="p">,</span><span class="mi">12</span><span class="p">,</span><span class="mi">13</span><span class="p">,</span><span class="mi">14</span><span class="o">]</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="o">[</span><span class="mi">21</span><span class="p">,</span><span class="mi">22</span><span class="p">,</span><span class="mi">23</span><span class="o">]</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="o">[</span><span class="mi">31</span><span class="p">,</span><span class="mi">32</span><span class="p">,</span><span class="mi">33</span><span class="p">,</span><span class="mi">34</span><span class="o">]</span><span class="p">})</span>
<span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">(</span><span class="o">[</span><span class="p">{</span><span class="ss">a</span><span class="p">:</span><span class="mi">1</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="mi">2</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="mi">3</span><span class="p">},</span><span class="s1">&#39;not an Array&#39;</span><span class="p">,{</span><span class="ss">a</span><span class="p">:</span><span class="mi">2</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="mi">3</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="mi">4</span><span class="p">,</span><span class="ss">e</span><span class="p">:</span><span class="mi">5</span><span class="p">}</span><span class="o">]</span><span class="p">)</span>
<span class="no">IRuby</span><span class="o">.</span><span class="n">display</span><span class="w"> </span><span class="no">IRuby</span><span class="o">.</span><span class="n">table</span><span class="p">(</span><span class="o">[</span><span class="p">{</span><span class="ss">a</span><span class="p">:</span><span class="mi">1</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="mi">2</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="mi">3</span><span class="p">},{</span><span class="ss">a</span><span class="p">:</span><span class="mi">2</span><span class="p">,</span><span class="ss">b</span><span class="p">:</span><span class="mi">3</span><span class="p">,</span><span class="ss">c</span><span class="p">:</span><span class="mi">4</span><span class="p">,</span><span class="ss">d</span><span class="p">:</span><span class="mi">5</span><span class="p">},{</span><span class="mi">0</span><span class="o">=&gt;</span><span class="ss">:x</span><span class="p">,</span><span class="mi">1</span><span class="o">=&gt;</span><span class="ss">:y</span><span class="p">},</span><span class="o">[</span><span class="ss">:a</span><span class="p">,</span><span class="ss">:b</span><span class="p">,</span><span class="ss">:c</span><span class="o">]]</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output text_html"><table><tr><td>1</td></tr><tr><td>2</td></tr><tr><td></td></tr><tr><td>3</td></tr></table></div><div class="output text_html"><table><tr><th>a</th><th>b</th><th>c</th></tr><tr><td>1</td><td>2</td><td>3</td></tr></table></div><div class="output text_html"><table><tr><td>11</td><td>12</td><td>13</td><td>14</td></tr><tr><td>21</td><td>22</td><td>23</td><td></td></tr><tr><td colspan='4'>not an Array</td></tr><tr><td>31</td><td>32</td><td>33</td><td>34</td></tr></table></div><div class="output text_html"><table><tr><th>a</th><th>b</th><th>c</th></tr><tr><td>11</td><td>21</td><td>31</td></tr><tr><td>12</td><td>22</td><td>32</td></tr><tr><td>13</td><td>23</td><td>33</td></tr><tr><td>14</td><td></td><td>34</td></tr></table></div><div class="output text_html"><table><tr><th>a</th><th>b</th><th>c</th><th>e</th></tr><tr><td>1</td><td>2</td><td>3</td><td></td></tr><tr><td colspan='4'>not an Array</td></tr><tr><td>2</td><td>3</td><td>4</td><td>5</td></tr></table></div><div class="output text_html"><table><tr><th>a</th><th>b</th><th>c</th><th>d</th><th>0</th><th>1</th><th>2</th></tr><tr><td>1</td><td>2</td><td>3</td><td></td><td></td><td></td><td></td></tr><tr><td>2</td><td>3</td><td>4</td><td>5</td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td><td>x</td><td>y</td><td></td></tr><tr><td></td><td></td><td></td><td></td><td>a</td><td>b</td><td>c</td></tr></table></div></div>
</div>
</section>
<section id="integration-with-ruby-gems">
<h2>Integration with Ruby gems<a class="headerlink" href="#integration-with-ruby-gems" title="Link to this heading">#</a></h2>
<section id="pry">
<h3>Pry<a class="headerlink" href="#pry" title="Link to this heading">#</a></h3>
<p><a class="reference external" href="https://github.com/pry/pry">Pry</a> is an enhanced Ruby REPL. It will be automatically used by IRuby if available. You can use the code browsing utilities for example.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="n">ls</span><span class="w"> </span><span class="nb">Array</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output stream highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span><span class=" -Color -Color-Bold -Color-Bold-Blue">Object.methods</span>: yaml_tag
<span class=" -Color -Color-Bold -Color-Bold-Blue">Array.methods</span>: []  try_convert
<span class=" -Color -Color-Bold -Color-Bold-Blue">Array#methods</span>: 
...
<p><code class="docutils literal notranslate"><span class="pre">Gnuplot::Plot</span></code> objects are automatically displayed inline as SVG.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="nb">require</span><span class="w"> </span><span class="s1">&#39;gnuplot&#39;</span>

<span class="no">Gnuplot</span><span class="o">::</span><span class="no">Plot</span><span class="o">.</span><span class="n">new</span><span class="w"> </span><span class="k">do</span><span class="w"> </span><span class="o">|</span><span class="n">plot</span><span class="o">|</span><span class="w">  </span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">xrange</span><span class="w"> </span><span class="s1">&#39;[-0.5:0.5]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">title</span><span class="w">  </span><span class="s1">&#39;Example plot&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">ylabel</span><span class="w"> </span><span class="s1">&#39;x&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">xlabel</span><span class="w"> </span><span class="s1">&#39;sin(1/x)&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">samples</span><span class="w"> </span><span class="mi">10000</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">data</span><span class="w"> </span><span class="o">&lt;&lt;</span><span class="w"> </span><span class="no">Gnuplot</span><span class="o">::</span><span class="no">DataSet</span><span class="o">.</span><span class="n">new</span><span class="p">(</span><span class="s1">&#39;sin(1/x)&#39;</span><span class="p">)</span><span class="w"> </span><span class="k">do</span><span class="w"> </span><span class="o">|</span><span class="n">ds</span><span class="o">|</span>
<span class="w">        </span><span class="n">ds</span><span class="o">.</span><span class="n">with</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;lines&#39;</span>
<span class="w">        </span><span class="n">ds</span><span class="o">.</span><span class="n">linewidth</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">2</span>
...
<div class="cell_output docutils container">
<img alt="../../../../../../../../_images/6be17c1576c268deb70f6c314dfd414ba58ba8ae072f06bd5816b6ebf54f123d.svg" src="../../../../../../../../_images/6be17c1576c268deb70f6c314dfd414ba58ba8ae072f06bd5816b6ebf54f123d.svg" />
</div>
</div>
<p>You can also create nice 3D plots</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="no">Gnuplot</span><span class="o">::</span><span class="no">SPlot</span><span class="o">.</span><span class="n">new</span><span class="w"> </span><span class="k">do</span><span class="w"> </span><span class="o">|</span><span class="n">plot</span><span class="o">|</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">title</span><span class="w"> </span><span class="s1">&#39;Spiral&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">nokey</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">parametric</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">hidden3d</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">view</span><span class="w"> </span><span class="s1">&#39;80,50&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">isosamples</span><span class="w"> </span><span class="s1">&#39;60,15&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">xrange</span><span class="w"> </span><span class="s1">&#39;[-8:8]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">yrange</span><span class="w"> </span><span class="s1">&#39;[-8:8]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">zrange</span><span class="w"> </span><span class="s1">&#39;[-8:8]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">urange</span><span class="w"> </span><span class="s1">&#39;[-2*pi:2*pi]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">vrange</span><span class="w"> </span><span class="s1">&#39;[-pi:pi]&#39;</span>
<span class="w">    </span><span class="n">plot</span><span class="o">.</span><span class="n">data</span><span class="w"> </span><span class="o">&lt;&lt;</span><span class="w"> </span><span class="no">Gnuplot</span><span class="o">::</span><span class="no">DataSet</span><span class="o">.</span><span class="n">new</span><span class="p">(</span><span class="s1">&#39;cos(u)*(cos(v)+3), sin(u)*(cos(v)+3), sin(v)+u&#39;</span><span class="p">)</span><span class="w"> </span><span class="k">do</span><span class="w"> </span><span class="o">|</span><span class="n">ds</span><span class="o">|</span>
<span class="w">        </span><span class="n">ds</span><span class="o">.</span><span class="n">with</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;lines&#39;</span>
<span class="w">    </span><span class="k">end</span>
<span class="k">end</span>
</pre></div>
...
<div class="cell_output docutils container">
<img alt="../../../../../../../../_images/6e17891344bec621b317b8918d32a6621ddc58e08aa498b77c0480f08d06d4e4.svg" src="../../../../../../../../_images/6e17891344bec621b317b8918d32a6621ddc58e08aa498b77c0480f08d06d4e4.svg" />
</div>
</div>
</section>
<section id="rubyvis">
<h3>Rubyvis<a class="headerlink" href="#rubyvis" title="Link to this heading">#</a></h3>
<p><code class="docutils literal notranslate"><span class="pre">Rubyvis</span></code> objects are automatically displayed inline as SVG.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="nb">require</span><span class="w"> </span><span class="s1">&#39;rubyvis&#39;</span>
<span class="w">    </span>
<span class="no">Rubyvis</span><span class="o">::</span><span class="no">Panel</span><span class="o">.</span><span class="n">new</span><span class="w"> </span><span class="k">do</span><span class="w"> </span>
<span class="w">  </span><span class="n">width</span><span class="w"> </span><span class="mi">150</span>
<span class="w">  </span><span class="n">height</span><span class="w"> </span><span class="mi">150</span>
<span class="w">  </span><span class="n">bar</span><span class="w"> </span><span class="k">do</span>
<span class="w">    </span><span class="n">data</span><span class="w"> </span><span class="o">[</span><span class="mi">1</span><span class="p">,</span><span class="w"> </span><span class="mi">1</span><span class="o">.</span><span class="mi">2</span><span class="p">,</span><span class="w"> </span><span class="mi">1</span><span class="o">.</span><span class="mi">7</span><span class="p">,</span><span class="w"> </span><span class="mi">1</span><span class="o">.</span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">0</span><span class="o">.</span><span class="mi">7</span><span class="p">,</span><span class="w"> </span><span class="mi">0</span><span class="o">.</span><span class="mi">3</span><span class="o">]</span>
<span class="w">    </span><span class="n">width</span><span class="w"> </span><span class="mi">20</span>
<span class="w">    </span><span class="n">height</span><span class="w"> </span><span class="p">{</span><span class="o">|</span><span class="n">d</span><span class="o">|</span><span class="w"> </span><span class="n">d</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="mi">80</span><span class="p">}</span>
<span class="w">    </span><span class="n">bottom</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
<span class="w">    </span><span class="n">left</span><span class="w"> </span><span class="p">{</span><span class="n">index</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="mi">25</span><span class="p">}</span>
<span class="w">  </span><span class="k">end</span>
<span class="k">end</span>
</pre></div>
</div>
...
<div class="cell_output docutils container">
<img alt="../../../../../../../../_images/496d6a217751fe25b5fd0b634676d47f931b2a4f61241f66594c61e06ab67435.svg" src="../../../../../../../../_images/496d6a217751fe25b5fd0b634676d47f931b2a4f61241f66594c61e06ab67435.svg" />
</div>
</div>
</section>
<section id="matrix-gsl">
<h3>Matrix &amp; GSL<a class="headerlink" href="#matrix-gsl" title="Link to this heading">#</a></h3>
<p><code class="docutils literal notranslate"><span class="pre">Matrix</span></code> and <code class="docutils literal notranslate"><span class="pre">GSL::Matrix</span></code> objects are automatically displayed as <span class="math notranslate nohighlight">\(\LaTeX\)</span>.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="nb">require</span><span class="w"> </span><span class="s1">&#39;matrix&#39;</span>
<span class="no">Matrix</span><span class="o">[[</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">,</span><span class="mi">3</span><span class="o">]</span><span class="p">,</span><span class="o">[</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">,</span><span class="mi">3</span><span class="o">]]</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
...
<section id="nyaplot">
<h3>Nyaplot<a class="headerlink" href="#nyaplot" title="Link to this heading">#</a></h3>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ruby notranslate"><div class="highlight"><pre><span></span><span class="nb">require</span><span class="w"> </span><span class="s1">&#39;nyaplot&#39;</span>

<span class="n">x</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="o">[]</span><span class="p">;</span><span class="w"> </span><span class="n">y</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="o">[]</span><span class="p">;</span><span class="w"> </span><span class="n">theta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">0</span><span class="o">.</span><span class="mi">6</span><span class="p">;</span><span class="w"> </span><span class="n">a</span><span class="o">=</span><span class="mi">1</span>
<span class="k">while</span><span class="w"> </span><span class="n">theta</span><span class="w"> </span><span class="o">&lt;</span><span class="w"> </span><span class="mi">14</span><span class="o">*</span><span class="no">Math</span><span class="o">::</span><span class="no">PI</span><span class="w"> </span><span class="k">do</span>
<span class="w">  </span><span class="n">x</span><span class="o">.</span><span class="n">push</span><span class="p">(</span><span class="n">a</span><span class="o">*</span><span class="no">Math</span><span class="o">::</span><span class="n">cos</span><span class="p">(</span><span class="n">theta</span><span class="p">)</span><span class="o">/</span><span class="n">theta</span><span class="p">)</span>
<span class="w">  </span><span class="n">y</span><span class="o">.</span><span class="n">push</span><span class="p">(</span><span class="n">a</span><span class="o">*</span><span class="no">Math</span><span class="o">::</span><span class="n">sin</span><span class="p">(</span><span class="n">theta</span><span class="p">)</span><span class="o">/</span><span class="n">theta</span><span class="p">)</span>
<span class="w">  </span><span class="n">theta</span><span class="w"> </span><span class="o">+=</span><span class="w"> </span><span class="mi">0</span><span class="o">.</span><span class="mi">1</span>
<span class="k">end</span>
<span class="n">plot1</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="no">Nyaplot</span><span class="o">::</span><span class="no">Plot</span><span class="o">.</span><span class="n">new</span>
<span class="n">plot1</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="ss">:line</span><span class="p">,</span><span class="w"> </span><span class="n">x</span><span class="p">,</span><span class="w"> </span><span class="n">y</span><span class="p">)</span>
<span class="n">plot1</span><span class="o">.</span><span class="n">show</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<script type="application/javascript">if(window['d3'] === undefined ||
...
(function(){
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "ruby",
            path: "./.venv/lib64/python3.10/site-packages/mkdocs_jupyter/tests/mkdocs/docs"
        },
